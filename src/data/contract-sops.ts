...
// ─── 亚洲英语系高端 deliverable templates ────────────────────
//
// Source: 「亚英硕士高端产品规划服务内容梳理.docx」 (2026 财年总部产品手册)
// 三档 A / B / C 共享前期 + 中期流程，B (¥49,800) / C (¥59,800) 多一项夏校
// 申请指导。每月至少 1 次沟通，当季申请客户每月 2 次以上有效沟通。

const yayingKickoff: Deliverable = {
  key: 'ya-kickoff',
  title: '服务开启 · 欢迎邮件',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 服务开启 · 欢迎邮件',
  emailBody: `{{学生姓名}}同学：

你好！

感谢你对苏州前途的信任，欢迎加入亚英硕士高端申请服务。我是你的中期规划师 {{中期顾问}}，接下来我们将携手为你的港 / 新 / 马等亚洲英语系院校硕士申请做出更科学的规划。

通过与前期顾问老师的对接，我已对你目前的情况有了基本了解。为了开始第一次脑暴沟通，请协助补充以下材料：

1. 简历信息表（附件，请如实填写并发回）
2. 已完成学年的成绩单电子版（中英文均可，无需正式开具）
3. 在读专业的培养方案 / 课程列表（含必修与选修）
4. 已有的标化成绩 / 语言成绩 / 实习 / 科研 / 竞赛 等材料

我们的服务团队：
• {{中期顾问}}（中期规划师）— 头脑风暴 / 留学时间规划 / 院校与专业匹配 / 标化与 GPA 跟进
• 文案老师（定校后引入）— 文书写作 / 网申填写 / 面试指导
• 前期顾问 — 全程跟盯 / 背景提升产品 / 日常资料整理

收到回信后我们建立沟通群，约第一次头脑风暴的时间。
...
const yayingBrainstormFeedback: Deliverable = {
  key: 'ya-brainstorm-feedback',
  title: '第一次脑暴 · 沟通汇总',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 第一次脑暴沟通汇总',
  emailBody: `{{学生姓名}}同学：

你好！

今天和你完成了第一次头脑风暴，这边把核心信息汇总一下，方便你和家长一起回顾：

▎当前背景定位
- 学校 / 专业 / GPA 现状
- 标化进度（雅思 / 托福 / GRE / GMAT 各项状态）
- 已完成 / 在做的科研 / 实习 / 竞赛
...
▎下一步动作
1. 我会在一周内出一份《留学时间规划书》，以你毕业前的时间线为骨架，标出各项准备节点
2. 你这边：按上面的提升点开始准备，遇到问题随时群里 / 邮件 同步给我
3. 之后每月做一次进度沟通，标化和 GPA 是申请季前最重要的两个变量

如有补充或想法，告诉我，会带进时间规划书一起调整。
...
const yayingRoadmap: Deliverable = {
  key: 'ya-roadmap',
  title: '留学时间规划书',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 留学时间规划书',
  emailBody: `{{学生姓名}}同学：

你好！

附件是基于上周脑暴沟通整理的《{{学生姓名}} 留学时间规划书》，覆盖从现在到申请季 + offer 季的关键节点。

▎规划书包含
- 各学期学业目标（GPA 提升节奏）
- 标化考试时间表（雅思 / 托福 / GRE / GMAT 报名 / 备考 / 考试节点）
- 科研 / 实习 / 竞赛阶段安排
- 申请季时间表（材料准备 / 文书 / 网申 / 面试）
- offer 后签证与入学准备

请你和家长一起仔细看一遍，把疑问和想调整的地方整理出来，下次月度沟通对齐。
...
const yayingMajorSchool: Deliverable = {
  key: 'ya-major-school',
  title: '专业分析与初步院校信息',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 专业分析与初步院校信息',
  emailBody: `{{学生姓名}}同学：

你好！

基于上一阶段的脑暴沟通，我整理了一份专业分析与初步可关注的院校清单，附件查收。

▎报告包含
- 你意向方向在港 / 新 / 马 各地区的主要项目（含 HKU / HKUST / CUHK / CityU / PolyU / NUS / NTU / NUM 等）
- 各项目的核心课程结构 / 偏好背景 / 申请要求（GPA / 雅思托福 / GRE-GMAT / 是否需要科研或实习背景）
- 学费 / 学制 / 就业去向参考

▎重要提示
**这份院校信息不是定校结果，只是让你了解阶段。** 最终申请学校会根据你毕业前的最终 GPA、标化分数、背景提升完成度，在申请季前 2-3 个月与你协商敲定。
...
const yayingBackgroundBoost: Deliverable = {
  key: 'ya-background-boost',
  title: '背景提升产品建议',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 背景提升建议',
  emailBody: `{{学生姓名}}同学：

你好！

对照你的目标专业要求和当前背景，目前能进一步提升竞争力的方向如下（按对申请的影响力排序）：

▎建议的提升路径
- [理工 / CS] 1-2 个海外名校 / 国内顶校的科研项目（独立 / 共同一作产出论文为佳）
- [商科 / 金融] 1-2 段品牌实习（投行 / 咨询 / 头部企业财务岗），或行业研究类产出
- [跨学科 / 转方向] 补充该方向相关课程 / Coursera 证书 / 项目实战

▎可考虑的合作产品（前期顾问会另行联系）
- 「海外名校导师远程科研」— 适合理工 / 商科科研背景缺口
- 「优企实习」— 适合需要实习背景的商科 / 跨方向学生
- 「就业力定制版科研」— 商科为主，含 paper 产出
- 「论文 / 竞赛 1对1 辅导」— 已有项目但缺指导

这些产品不是强制，请基于实际需要选择，不需要全部参加。如果你 / 家长对某个方向感兴趣，可以直接联系前期顾问详细了解。
...
const yayingEnglishCard: Deliverable = {
  key: 'ya-english-card',
  title: '英语学习卡发放',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 英语学习卡',
  emailBody: `{{学生姓名}}同学：

你好！

按合同约定，发你一张新东方在线英语学习卡，可用于雅思 / 托福相关课程学习：
...
▎使用建议
- 优先按规划书时间表选课
- 建议固定每天 1-1.5 小时 + 周末一次 review
- 在沟通群里同步学习进度，方便我帮你判断后续报名节点

如果激活遇到问题或者课表不清楚，告诉我，我让前期老师协助处理。
...
const yayingGreGmatCard: Deliverable = {
  key: 'ya-gre-gmat-card',
  title: 'GRE / GMAT 学习卡发放',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} GRE / GMAT 学习卡',
  emailBody: `{{学生姓名}}同学：

你好！

按合同约定，发你一张 GRE / GMAT 学习卡：

▎学习卡信息
- 类型：GRE 或 GMAT（请确认你的目标）
- 卡号 / 激活码：[此处填实际信息]
- 有效期：[起止日期]
- 适用课程：含 [基础课 / 强化课 / 模考 / 真题精讲 等]
- 激活方式：[入口链接] → 输入激活码

▎使用建议
- 备考时间窗：建议在大三上学期末 / 大三下开始扎实推进
- 周打卡：建议两周一个小阶段，配合规划师定的目标分
- 模考节奏：临考前 4-6 周连刷模考，关注稳定性

如果想确认是不是真的需要 GRE / GMAT（部分港新项目并不要求），告诉我，我们看一下你目标学校的具体要求再定。
...
const yayingCourseSelection: Deliverable = {
  key: 'ya-course-selection',
  title: '学期前选课沟通',
  repeats: 4,
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 新学期选课建议',
  emailBody: `{{学生姓名}}同学：

你好！

新学期开学在即，按惯例提前帮你梳理一下选课方向，希望让你的课程背景在申请时与目标项目高度匹配。

▎本学期选课重点
- 必修课：[列出关键必修，标注是否硬性要求]
- 选修课建议：[结合你的意向方向，推荐 2-3 门 must-take]
- 慎选 / 不建议：[低 GPA 风险课 / 对申请加成有限的课]

▎要确认的事
1. 是否决定本学期选小方向 / 分流？
2. 选课过程中有无时间冲突 / 学分上限问题？
3. 是否需要加 / 减学分（影响 GPA 计算口径）？

如果选课系统截止前还有疑问，约个 15 分钟电话快速过一下。
...
const yayingSummerSchool: Deliverable = {
  key: 'ya-summer-school',
  title: '夏校推荐（仅 B / C 产品）',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 港新地区夏校推荐',
  emailBody: `{{学生姓名}}同学：

你好！

附件是我为你整理的港 / 新地区夏校推荐（Excel 详细对照表 + PPT 视觉版），共 [N] 个候选活动。

▎推荐说明
- 优先匹配你的意向专业方向
- 时间窗：6 月底 - 8 月底为主，避开期末考试与雅思 / 托福备考
- 申请门槛：大部分要求当前 GPA + 标化（雅思 / 托福），少数要求面试

▎前提条件提醒
申请夏校需要你**已经持有有效的雅思或托福成绩**。如果还没考出，建议优先冲刺标化考试，否则可能错过申请窗口。

▎下一步
1. 你和家长筛选出 3-5 所重点关注的
2. 我们一起再确认申请要求 / 截止时间
3. 文案老师介入完成文书 + 网申，我同步面试辅导（若需）和后续签注
...
const yayingFinalSchool: Deliverable = {
  key: 'ya-final-school',
  title: '定校确认 · 申请学校名单',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 定校确认 · 申请学校名单',
  emailBody: `{{学生姓名}}同学：

你好！

经过这一年多的跟进，结合你目前的最终 GPA、标化分数和背景提升完成度，整理了 [N] 所申请学校的最终名单，按梯度排列：
...
▎建议
- 总数控制在 6-9 所之间，保证文书与网申质量
- 至少保留 2 所保底，避免颗粒无收
- 冲刺校不超过 3 所，集中精力做 high-impact 文书

请你和家长一起 review，如果有想增加 / 删除的，告诉我们一起商量。**回复邮件确认**后，文案老师正式介入开始文书与网申。
...
const yayingAcademicWriting: Deliverable = {
  key: 'ya-academic-writing',
  title: '学术写作指导课程开通（offer 后）',
  emailSubject: '【苏州前途·亚英硕士高端】{{学生姓名}} 学术写作指导课程开通',
  emailBody: `{{学生姓名}}同学：

恭喜拿到 offer 🎉

按合同约定，为你开通学术写作指导课程（Academic Writing），帮助你顺利衔接硕士阶段的论文写作 / 课程作业。

▎课程信息
- 平台：[平台名]
- 账号 / 激活码：[实际信息]
- 有效期：[起止日期]
- 覆盖模块：论文结构 / Citation / Academic vocabulary / Critical analysis / 文献综述等

▎使用建议
- 入学前 2-3 个月开始最佳，与签证 / 行前准备同时推进
- 每周 2-3 小时即可，配合自己专业的英文阅读积累
- 第一节课后到群里反馈感受，我帮你调整学习节奏
...
export const SOPS: ContractSOP[] = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      yayingRoadmap,
      yayingMajorSchool,
      yayingBackgroundBoost,
      yayingEnglishCard,
      yayingGreGmatCard,
      yayingCourseSelection,
      yayingSummerSchool,
      yayingFinalSchool,
      yayingAcademicWriting,
    ],
    description: '港 / 新 / 马 等亚洲英语系院校硕士高端申请。2026 财年三档（A ¥39,800 / B ¥49,800 / C ¥59,800），B / C 含夏校申请指导。中期规划师全程跟盯：欢迎邮件 → 头脑风暴 → 留学时间规划书 → 专业 / 院校分析 → 背景提升建议 → 学习卡发放（英语 + GRE/GMAT，按合同）→ 学期前选课 → 夏校（B/C）→ 定校确认 → 学术写作课（offer 后）。非当季月度 1 次沟通，当季每月 2 次以上。',
    pricing: 'A ¥39,800 / B ¥49,800 / C ¥59,800',
    durationMonths: 18,
    targetAudience: '申请港 / 新 / 马 硕士项目的本科生，需要从中期（背景提升 + 选校匹配）到后期（文书 + 网申 + 签证）的全流程支持',
  },
  {
