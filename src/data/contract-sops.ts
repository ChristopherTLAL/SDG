...
export const SOPS: ContractSOP[] = [
  ...
  },
  {
    ...
    description: '港 / 新 / 马 等亚洲英语系院校硕士高端申请。2026 财年三档（A / B ¥49,800 / C ¥59,800），B / C 含夏校申请指导。中期规划师全程跟盯：欢迎邮件 → 头脑风暴 → 留学时间规划书 → 专业 / 院校分析 → 背景提升建议 → 学习卡发放（英语 + GRE/GMAT，按合同）→ 学期前选课 → 夏校（B/C）→ 定校确认 → 学术写作课（offer 后）。非当季月度 1 次沟通，当季每月 2 次以上。',
    pricing: 'A / B ¥49,800 / C ¥59,800',
    durationMonths: 18,
