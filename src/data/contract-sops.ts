...
我是 {{学生姓名}} 的中期规划顾问 {{中期顾问}}，感谢您对苏州前途的信任与配合。基于过去几次与 {{学生姓名}} 的深度沟通，中期规划团队为他/她完成了《生涯规划方案》初稿，详见附件。

▎方案内容
1. 兴趣 / 性格 / 学术倾向梳理
2. 中长期专业方向建议（1 主选 + 2 备选）
3. 与目标方向匹配的高中阶段学业规划
4. 学术之外的成长路径建议（科研 / 实习 / 竞赛 / 文体）

▎下一步
- 这份方案是后续所有月度规划的起点
- 建议您和 {{学生姓名}} 一起完整阅读一遍，把疑问 / 不认同的部分整理出来
- 下次沟通我们一起对齐与调整
...
附件是为 {{学生姓名}} 准备的《简历梳理报告》。我们对当前阶段的所有学术、科研、活动、竞赛、文体经历做了系统化梳理与评估，作为后续文书 / 推荐信 / 申请简历的基础素材。

▎报告内容
1. 经历分类与时间轴（学术 / 科研 / 活动 / 竞赛 / 文体）
2. 每段经历的"亮点 / 待补充 / 申请价值"评估
3. 距离目标方向的差距分析
4. 后续 6–12 个月的补充建议（哪些值得继续投入、哪些可以止损）

▎使用建议
- 与生涯规划方案配合阅读
- 后续月度规划会围绕"差距分析"中的 priority 项推进
- 如对某段经历的评估有不同看法，请告知我们一起讨论
...
// 用一封邮件汇总所有交付物（附件 1-N），用于报完成留档。advisor 可以根据
// 实际情况编辑「附件清单」与「服务总结」两段。
...
{{学生姓名}} 的格物计划服务期已圆满结束。本邮件一次性汇总本期所有交付材料，便于您留档，也作为本次服务的正式结案。
