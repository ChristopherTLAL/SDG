...
export const article: Article = {
  ...
  vocab: [
    { id: 'v1', word: 'lending', lemma: 'lend', sentenceId: 's3', level: 'CET4', pos: 'v.', ipa: '/ˈlendɪŋ/', defZh: '借出（给别人）', defEn: 'giving something to someone for a short time', example: 'My friend is lending me his bike for the weekend.', exampleZh: '朋友周末把自行车借给我。' },
    { id: 'v2', word: 'expensive', lemma: 'expensive', sentenceId: 's7', level: 'CET4', pos: 'adj.', ipa: '/ɪkˈspensɪv/', defZh: '昂贵的', defEn: 'costing a lot of money', example: 'Good cameras are expensive.', exampleZh: '好相机很贵。' },
    { id: 'v3', word: 'store', lemma: 'store', sentenceId: 's7', level: 'CET4', pos: 'v.', ipa: '/stɔːr/', defZh: '存放；储存', defEn: 'to keep something in a place until it is needed', example: 'We store winter coats in the closet during summer.', exampleZh: '夏天我们把冬大衣放在壁橱里。' },
    { id: 'v4', word: 'borrow', lemma: 'borrow', sentenceId: 's8', level: 'CET4', pos: 'v.', ipa: '/ˈbɒrəʊ/', defZh: '借（向别人借入）', defEn: 'to take something from someone, planning to give it back', example: 'Can I borrow your pen?', exampleZh: '我能借你的笔用一下吗？' },
    { id: 'v5', word: 'waste', lemma: 'waste', sentenceId: 's10', level: 'CET4', pos: 'n.', ipa: '/weɪst/', defZh: '废弃物；浪费', defEn: 'material that is no longer useful and is thrown away', example: 'The city is trying to reduce food waste.', exampleZh: '这座城市正在努力减少食物浪费。' },
    { id: 'v6', word: 'experienced', lemma: 'experienced', sentenceId: 's11', level: 'CET4', pos: 'adj.', ipa: '/ɪkˈspɪəriənst/', defZh: '有经验的；熟练的', defEn: 'having a lot of knowledge from doing something for a long time', example: 'She is an experienced teacher.', exampleZh: '她是一位经验丰富的老师。' },
    { id: 'v7', word: 'volunteers', lemma: 'volunteer', sentenceId: 's11', level: 'CET4', pos: 'n.', ipa: '/ˌvɒlənˈtɪərz/', defZh: '志愿者', defEn: 'people who do work without being paid', example: 'The festival is run entirely by volunteers.', exampleZh: '这个节日完全由志愿者运营。' },
    { id: 'v8', word: 'beginners', lemma: 'beginner', sentenceId: 's11', level: 'CET4', pos: 'n.', ipa: '/bɪˈɡɪnərz/', defZh: '初学者；新手', defEn: 'people who are starting to learn something', example: 'This class is for beginners.', exampleZh: '这门课是为初学者开设的。' },
    { id: 'v9', word: 'community', lemma: 'community', sentenceId: 's13', level: 'CET4', pos: 'n.', ipa: '/kəˈmjuːnəti/', defZh: '社区；社群', defEn: 'a group of people who live in the same area or share interests', example: 'The community held a fundraiser for the school.', exampleZh: '社区为学校办了一场筹款活动。' },
    { id: 'v10', word: 'neighbor', lemma: 'neighbor', sentenceId: 's14', level: 'CET4', pos: 'n.', ipa: '/ˈneɪbər/', defZh: '邻居', defEn: 'someone who lives next to or near you', example: 'Our neighbor watches our cat when we travel.', exampleZh: '我们出差时邻居会帮我们看猫。' },
    { id: 'v11', word: 'workshops', lemma: 'workshop', sentenceId: 's14', level: 'CET6', pos: 'n.', ipa: '/ˈwɜːrkʃɒps/', defZh: '工作坊；研讨班', defEn: 'meetings where people learn or practice a skill together', example: 'The library runs free coding workshops on Saturdays.', exampleZh: '图书馆每周六举办免费的编程工作坊。' },
    { id: 'v12', word: 'household', lemma: 'household', sentenceId: 's15', level: 'CET6', pos: 'adj.', ipa: '/ˈhaʊshəʊld/', defZh: '家庭的；家用的', defEn: 'relating to a house and the people in it', example: 'Energy is a major household expense.', exampleZh: '能源是家庭主要支出之一。' },
    { id: 'v13', word: 'reduce', lemma: 'reduce', sentenceId: 's15', level: 'CET4', pos: 'v.', ipa: '/rɪˈdjuːs/', defZh: '减少；降低', defEn: 'to make something smaller or less', example: 'We are trying to reduce paper use in the office.', exampleZh: '我们在努力减少办公室的用纸。' },
    { id: 'v14', word: 'challenges', lemma: 'challenge', sentenceId: 's16', level: 'CET4', pos: 'n.', ipa: '/ˈtʃælɪndʒɪz/', defZh: '挑战；难题', defEn: 'difficult tasks that test someone\'s ability', example: 'Learning a new language has its challenges.', exampleZh: '学一门新语言会遇到不少挑战。' },
    { id: 'v15', word: 'wear out', lemma: 'wear out', sentenceId: 's17', level: 'CET6', pos: 'phr. v.', ipa: '/wer aʊt/', defZh: '磨损；用坏', defEn: 'to become damaged from being used a lot', example: 'These running shoes wear out in about six months.', exampleZh: '这双跑鞋大概半年就会磨坏。' },
    { id: 'v16', word: 'repair', lemma: 'repair', sentenceId: 's17', level: 'CET4', pos: 'v.', ipa: '/rɪˈpeər/', defZh: '修理；修补', defEn: 'to fix something that is broken', example: 'The shop can repair almost any kind of bike.', exampleZh: '这家店几乎能修任何一种自行车。' },
    { id: 'v17', word: 'insurance', lemma: 'insurance', sentenceId: 's18', level: 'CET6', pos: 'n.', ipa: '/ɪnˈʃʊərəns/', defZh: '保险', defEn: 'an arrangement that protects you against loss or damage', example: 'Most cars need insurance.', exampleZh: '大多数车都需要保险。' },
    { id: 'v18', word: 'tricky', lemma: 'tricky', sentenceId: 's18', level: 'CET6', pos: 'adj.', ipa: '/ˈtrɪki/', defZh: '棘手的；有难度的', defEn: 'difficult to deal with', example: 'Parking in this city can be tricky.', exampleZh: '在这座城市里停车有点麻烦。' },
    { id: 'v19', word: 'spreading', lemma: 'spread', sentenceId: 's19', level: 'CET6', pos: 'v.', ipa: '/ˈspredɪŋ/', defZh: '扩散；传开', defEn: 'reaching more places or people', example: 'The new style is spreading from Tokyo to Seoul.', exampleZh: '这种新风格正从东京传到首尔。' },
    { id: 'v20', word: 'steadily', lemma: 'steadily', sentenceId: 's19', level: 'CET6', pos: 'adv.', ipa: '/ˈstedɪli/', defZh: '稳步地；持续地', defEn: 'in a slow and continuous way', example: 'Her English is improving steadily.', exampleZh: '她的英语在稳步进步。' },
  ],
  collocations: [
